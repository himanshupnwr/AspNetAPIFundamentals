...
using AspNetAPIFundamentals.Entities;
...
namespace AspNetAPIFundamentals.Services
{
    public class CityInfoRepository : ICityInfoRepository
    {
            ...
            string? name, string? searchQuery, int pageNumber, int pageSize)
        {
            ...
            //this is a database call to get the total count of the data in the table collection
        ...
        {
            return await _context.Cities.AnyAsync(city => city.Id == cityId && city.Name == cityName);
        }
    }
}
